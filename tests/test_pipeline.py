...
def test_pipeline_success(mock_out_init, mock_struct_init, mock_intake, mock_struct, mock_output):
...
@patch("agents.structuring_agent.StructuringAgent.__init__", return_value=None)
@patch("agents.output_agent.OutputAgent.__init__", return_value=None)
def test_pipeline_intake_fail(mock_out_init, mock_struct_init, mock_intake):
    pipeline = HealthcarePipeline()
...
@patch("agents.structuring_agent.StructuringAgent.__init__", return_value=None)
@patch("agents.output_agent.OutputAgent.__init__", return_value=None)
def test_pipeline_structuring_fail(mock_out_init, mock_struct_init, mock_struct_run, mock_intake):
    pipeline = HealthcarePipeline()
